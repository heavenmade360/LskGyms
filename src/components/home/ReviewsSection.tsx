...
const reviews = [
  {
    name: "Emily H.",
    text: "I've been a member of APEX ATHLETICS for over a year, and I can't imagine my fitness routine without it. The group classes are my favorite – they're challenging, fun, and led by enthusiastic instructors."
  },
  {
    name: "Alexandra T.",
    text: "Joining APEX ATHLETICS was the best decision I made for my fitness journey. The trainers are so supportive and knowledgeable. The community here is incredible."
  },
  {
    name: "Michael R.",
