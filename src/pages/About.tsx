    ...
    <div className="flex flex-col">
      ...
      <div className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
            <div>
              <h2 className="text-3xl font-heading font-black uppercase tracking-tighter text-brand-dark mb-6">Our Story</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-brand-gray border border-zinc-100 p-8 rounded-2xl">
              <div className="w-14 h-14 bg-brand-orange/10 rounded-xl flex items-center justify-center text-brand-orange mb-6">
                <Target className="w-8 h-8" />
              </div>
              <h3 className="text-xl font-bold font-heading text-brand-dark uppercase tracking-wider mb-3">Our Mission</h3>
              <p className="text-zinc-600">To provide Zambians with an unmatched fitness environment where ambition meets expert guidance, empowering every member across the nation to live stronger.</p>
            </div>
            <div className="bg-brand-gray border border-zinc-100 p-8 rounded-2xl">
              <div className="w-14 h-14 bg-brand-orange/10 rounded-xl flex items-center justify-center text-brand-orange mb-6">
                <Trophy className="w-8 h-8" />
              </div>
              <h3 className="text-xl font-bold font-heading text-brand-dark uppercase tracking-wider mb-3">Elite Equipment</h3>
              <p className="text-zinc-600">We exclusively use Life Fitness equipment, globally recognized for its biomechanics, durability, and smooth performance.</p>
            </div>
            <div className="bg-brand-gray border border-zinc-100 p-8 rounded-2xl">
              <div className="w-14 h-14 bg-brand-orange/10 rounded-xl flex items-center justify-center text-brand-orange mb-6">
                <Clock className="w-8 h-8" />
              </div>
              <h3 className="text-xl font-bold font-heading text-brand-dark uppercase tracking-wider mb-3">Flexible access</h3>
              <p className="text-zinc-600">Open 7 days a week with extended weekday hours to ensure your schedule never stands in the way of your workout.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-brand-gray py-24">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl sm:text-4xl font-heading font-black uppercase tracking-tighter text-brand-dark mb-6">Ready to see it yourself?</h2>
          <p className="text-zinc-600 text-lg mb-8">We invite you to tour our facility. Come see the equipment, meet the team, and feel the atmosphere.</p>
          <Link to="/contact" className="inline-flex items-center gap-2 bg-brand-orange hover:bg-orange-600 text-white px-8 py-4 rounded-full font-bold uppercase tracking-widest text-sm transition-all">
